 ...
 * Telegram:  https://t.me/PepeQueenCoin

 * Website: https://pepequeen.finance
*/
...
contract PEPEQUEENCOIN is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("PEPEQUEEN", "PepeQueen") {
        ...
        maxBuyAmount = totalSupply / 1; // 100% maxTransactionAmountTxn
        maxSellAmount = totalSupply / 1; // 100% maxTransactionAmountTxn
        ...
        marketingWallet = address(0x43fa642aDe2a07d0461cE9F07886b4e3f668721F);
        contestAIWallet = address(0x43fa642aDe2a07d0461cE9F07886b4e3f668721F);
